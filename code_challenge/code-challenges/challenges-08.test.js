...
const containsAnd = (arr) => {
  // Solution code here...
  return arr.filter(elem=>elem.includes('and')?elem:null)
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  return arr.filter(elem=>elem.match(/[aeiou]/g))
...
const getStatName = (arr, minBaseStat) => {
  ...
  let arr0 = []
  arr.forEach(elem=>{
    if(elem.baseStat>minBaseStat) arr0.push(elem.stat.name)
  })
  return arr0
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let arr0=[]
  arr.forEach(elem=>typeof elem=='number'?elem%2==0?arr0.push('even'):arr0.push('odd'):null)
  return arr0
};
